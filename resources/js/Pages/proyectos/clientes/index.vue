 ...
 <AppLayout title="Clientes">
    ...
    <div class="py-4">
            <div class="max-w-full mx-2 sm:px-6 lg:px-8">
                ...
                <DataTable ref="dt" :value="props.clientes" class="p-datatable-sm" filterDisplay="menu" dataKey="id" v-model:filters="filters" 
                :globalFilterFields="['name','type', 'material_casco']"  showGridlines  :paginator="true" :rows="25" :rowsPerPageOptions="[25,50,100]">
                    ...
                    <Column field="nombre_cliente" header="Nombre"  sortable></Column>
                    <Column field="tipo_cliente" header="Tipo Cliente"  sortable></Column>
                    <Column field="pais" header="Pais" sortable></Column>
