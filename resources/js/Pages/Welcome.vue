...
<template>
  ...
  <div class="bg-white dark:bg-gray-900">
    ...
    <div class="bg-white relative pt-40 pb-20 lg:pt-44 dark:bg-gray-900">
      <div class="relative xl:container m-auto px-6 md:px-12 lg:px-4">
        <h1
          class="
          ...
          "
        >
          Servicios digitales GECON <br class="lg:block hidden" />
          <span
            class="
              relative
              text-transparent
        ...
        <div class="lg:flex">
          ...
          >
            ...
            <span class="block font-semibold text-gray-500 dark:text-gray-400"
              >The best companion bot for your chat app.</span
            >
          </div>
    ...
    <div class="bg-white dark:bg-gray-900 m-auto px-6 md:px-12 lg:px-4 mt-0 sm:mt-44">
